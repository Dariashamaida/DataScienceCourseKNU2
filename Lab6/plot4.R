...
plot(two_days$DateTime, two_days$Global_active_power, 
     type = "l", 
     xlab = "",  
...
plot(two_days$DateTime, two_days$Sub_metering_1, 
     type = "l", 
     xlab = "", 
...
plot(two_days$DateTime, two_days$Global_reactive_power, 
     type = "l", 
     xlab = "datetime",  
